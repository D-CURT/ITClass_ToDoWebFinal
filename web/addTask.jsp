...
<div class="wrapper">
    ...
    <form action="edit" method="post" name="add">
        ...
        <table border="1">
            ...
            <tr>
                <td><input type="text" name="<%= Constants.PARAM_TITLE_TASK%>" value="" placeholder="Title"></td>
                <td><input type="text" name="<%= Constants.PARAM_CONTENT_TASK%>" value="" placeholder="Content"></td>
