...
public final class SQLQuery {
    ...
    public static final String SELECT_DATE_TASK = "SELECT dateTask FROM task WHERE idUSER = (SELECT id FROM user WHERE login=?) AND dateTask = curdate()";
    ...
    public static final String WHERE_OLD_TASK = "AND dateTask < curdate() AND flagFix = 0 AND flagRecycle = 1";
    ...
    public static final String EDIT_TASK = "UPDATE task SET titleTask=?, contentTask=?, dateTask=? WHERE id=?";
